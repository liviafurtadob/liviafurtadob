...
Meu nome é Lívia Furtado Borges , atualmente moro em Bonn, Alemanha . Sou uma cientista social entusiasta de métodos e Ciências Sociais Computacionais. Sou mestra em Educação pela [PPGE/UNIFAL](https://www.unifal-mg.edu.br/ppge/). Estou estudando Ciências Sociais e de dados com algumas linguagens de programação como HTML e CSS, Ruby on Rails, R, Python, JavaScript e assim por diante. 
